...
const PrivateEquityDataMaturityAssessment = () => {
      ...
      console.log('💾 Assessment data available at: window.assessmentData');
        ...
        <div className="bg-blue-50 p-6 rounded-lg mb-8">
          ...
          <div className="space-y-3">
            ...
            <div className="text-center p-4 bg-gray-50 rounded-lg">
              ...
              <div className="text-2xl font-bold text-blue-600">{scores.coverage}%</div>
            ...
            <div className="text-center p-4 bg-gray-50 rounded-lg">
              ...
              <div className="text-2xl font-bold text-blue-600">{scores.confidence}%</div>
            ...
            <div className="text-center p-4 bg-gray-50 rounded-lg">
              ...
              <div className="text-2xl font-bold text-blue-600">{scores.latency}%</div>
            ...
            <div className="text-center p-4 bg-gray-50 rounded-lg">
              ...
              <div className="text-2xl font-bold text-blue-600">{scores.forecast}%</div>
        ...
        <div className="text-center mb-8">
          <div className="inline-block bg-blue-600 text-white px-6 py-3 rounded-lg">
            ...
            <span className="text-2xl font-bold">{scores.total}/50</span>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-6 mb-6 items-stretch">
          <button 
            onClick={() => window.open(ctaConfig.primaryCTALink || 'https://hubs.ly/Q03w50s40', '_blank', 'noopener,noreferrer')}
            style={{
      ...
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Assess your portfolio company's data maturity in 2 minutes
          </p>
          <div className="text-sm text-gray-500 mt-1">PE Edition v1.0</div>
        </div>
...
export default PrivateEquityDataMaturityAssessment;